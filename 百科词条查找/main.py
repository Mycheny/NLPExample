...
if __name__ == '__main__':
    ...
    for index, school in enumerate(schools[:1]):
        ...
        result_data.append({'中文名': result['中文名'], '英文名': result['英文名'], '简称': result['简称'], '所属地区': result['所属地区'],
                            '创办时间': result['创办时间'], '知名校友': result['知名校友'], '主要院系': result['主要院系']})
        print("正在读取")
