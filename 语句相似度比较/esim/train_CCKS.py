...
p, h, y = load_char_data('./data/CCKS/processed/train.tsv', data_size=None)
p_eval, h_eval, y_eval = load_char_data('./data/CCKS/processed/dev.tsv', data_size=1000)
...
with tf.Session(config=config)as sess:
    ...
    for epoch in range(args.epochs):
        ...
        print('\n')
        saver.save(sess, f'./model_CCKS/esim_{epoch}.ckpt')
